...
const popularTerms = ["React", "Next.js", "TypeScript", "Sistem Desain", "API"]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 text-center bg-muted/50">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:bg-clip-text hover:text-transparent transform hover:scale-105 transition-all">
            Blog | Artikel
          </h1>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto mb-5" />
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl blur opacity-25 group-hover:opacity-40 transition-opacity" />
              <div className="relative bg-background border-2 border-muted rounded-2xl p-2 group-hover:border-blue-500/50 group-hover:shadow-lg transition-all">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 flex justify-center items-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl text-white">
                    <Search className="h-5 w-5" />
                  </div>
                  <Input
                    placeholder="Cari artikel, tutorial, atau wawasan..."
                    className="flex-1 border-0 bg-transparent text-lg placeholder:text-muted-foreground/70 focus-visible:ring-0 h-12"
                  />
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 rounded-xl shadow-lg transform hover:scale-105"
                  >
                    Cari
                  </Button>
                </div>
            ...
            <div className="mt-4 flex flex-wrap gap-2 justify-center items-center">
              ...
              {popularTerms.map((term) => (
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="text-xs bg-muted/50 hover:bg-gradient-to-r hover:from-blue-600/10 hover:to-purple-600/10 hover:text-blue-600 transition-all rounded-full px-3 py-1"
                >
                  {term}
                </Button>
              ))}
        ...
        <div className="max-w-6xl mx-auto flex flex-wrap gap-2 justify-center">
          {categories.map((category) => (
            <Badge
              key={category}
              variant="outline"
              className="cursor-pointer hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:text-white hover:border-transparent transform hover:scale-105"
            >
              {category}
            </Badge>
          ))}
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="overflow-hidden hover:shadow-xl transform hover:scale-[1.02] transition-all">
            <div className="md:flex">
              <div className="md:w-1/2">
                <Image
                  src={featuredPost.image}
                  alt={`Gambar artikel: ${featuredPost.title}`}
              ...
              <div className="md:w-1/2 p-6 md:p-8">
                ...
                <h3 className="text-2xl md:text-3xl font-bold mb-4 hover:bg-clip-text hover:text-transparent hover:bg-gradient-to-r from-blue-600 to-purple-600">
                  {featuredPost.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button asChild className="hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:text-white transform hover:scale-105">
      ...
      <section className="py-16 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8 hover:bg-clip-text hover:text-transparent hover:from-blue-600 hover:to-purple-600 hover:bg-gradient-to-r">
            Artikel Terbaru
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <Card key={post.id} className="overflow-hidden hover:shadow-lg transform hover:scale-105 transition-all">
                ...
                <CardHeader>
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="outline" className="hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:text-white hover:border-transparent">
                      {post.category}
                    </Badge>
                ...
                <CardContent>
                  ...
                  <Button asChild variant="ghost" className="w-full mt-4 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:text-white transform hover:scale-105">
